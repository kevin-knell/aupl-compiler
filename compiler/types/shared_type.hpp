...
struct SharedType final : public Type {
	TypePtr type;
	...
	bool is_convertable_to_cpp_type(const std::string& cpp_type) const override { return type->is_convertable_to_cpp_type(cpp_type); }
