...
class NodeCompositionExpression;
...
private:
	...
	virtual void visit(NodeCompositionExpression& expr) = 0;
	...
	friend class NodeCompositionExpression;
};
...
private:
	...
	virtual void visit(NodeCompositionExpression& expr, VarExprPtr var_expr) = 0;
